...
exports.handler = async (event, context) => {
  ...
  let scope = 'user-read-private user-read-email user-read-playback-state user-modify-playback-state streaming app-remote-control playlist-read-private playlist-read-collaborative';
